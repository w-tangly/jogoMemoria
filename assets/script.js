...
const cardImages = [
    { name: 'Flor Alienígina', img: './img/Alien_FlowerGW2.webp' },
    { name: 'All-Star', img: './img/All-StarGW2.webp' },
    { name: 'Estrela de beisebol', img: './img/Baseball_StarGW2.webp' },
    { name: 'Cacto', img: './img/CactusGW2.webp' },
    { name: 'Capitão Barbamorta', img: './img/Captain_DeadbeardGW2.webp' },
    { name: 'Capitão Partyman', img: './img/Captain_PartymanGW2.webp' },
    // Adicione mais personagens para os níveis Médio e Difícil
    { name: 'Carnívora', img: './img/ChomperGW2.webp' },
    { name: 'Citrinador', img: './img/CitronGW2.webp' },
    { name: 'Engenheiro', img: './img/EngineerGW2.webp' },
    { name: 'Soldado', img: './img/Foot_SoldierGW2.webp' },
    { name: 'Citrinador Congelado', img: './img/Frozen_CitronGW2.webp' },
    { name: 'Carnívora Potente', img: './img/Hot_Rod_ChomperGW2.webp' },
    { name: 'Planador Cabra-3000', img: './img/Hover_Goat-3000GW2.webp' },
    { name: 'Zumbinho', img: './img/ImpGW2.webp' },
    { name: 'Cacto de Jade', img: './img/Jade_CactusGW2.webp' },
    { name: 'Coronel Milho', img: './img/Kernel_CornGW2.webp' },
    { name: 'Nec`Rosa', img: './img/Nec%27RoseGW2.webp' },
    { name: 'Paleontologista', img: './img/PaleontologistGW2.webp' }
];
